...
public class FileUtils{
     ...
     *
     * (Rough Translation)
     * This method converts path names or package names into correct path names 
     * depending on the platform. 
     * 
     * For example, a path name "/foo/boo" for Windows, which is common in the 
     * Unix world, would be converted to "\foo\boo" 
     * (the "wrongChar" would have to be specified here with '/')
     * 
     * @param pathString
     * @param wrongChar
     *    
     ...
     *  
     * (Rough Translation) 
     * This method reads the CLASSPATH string and splits it into a 
     * string field of individual paths.
     * 
     * @return 
     */
